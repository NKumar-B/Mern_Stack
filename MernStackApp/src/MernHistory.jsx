...
function MernHistory() {
    return (
        <div style={{backgroundColor:"rgba(233, 215, 233, 1)"}}>
            ...
            <p style={{ color: "black",   fontFamily: "Verdana" }}>The MERN stack evolved in the 2010s as developers shifted from fragmented multi-language stacks (like LAMP) to unified, 
